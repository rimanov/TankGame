...
public class Constants {
    ...
    public static final double PLAYER_TANK_INITIAL_HEALTH = 5;
    public static final double DUMBAI_TANK_INITIAL_HEALTH = 5;
    public static final double AI_TANK_INITIAL_HEALTH = 5;
